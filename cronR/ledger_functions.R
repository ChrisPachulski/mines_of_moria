...
tcg_sales_scryfall_marriage <- function(Recent_Sales,combined_attributes){
    ...
    Recent_Sales_Export$X...2 <- ifelse(Recent_Sales_Export$X...2 == "TCG" & Recent_Sales_Export$as.numeric.as.character.Recent_Sales.Ind_Amt.. <= 2.99, "TCG - Direct", Recent_Sales_Export$X...2 )
    Recent_Sales_Export$X...3 <- as.numeric(Recent_Sales$Base_Fee) + as.numeric(Recent_Sales$Direct_Fee)
    return(Recent_Sales_Export)
}
