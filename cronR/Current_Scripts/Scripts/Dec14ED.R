...
setwd("/cloud/project/Old Trackers/TCG Vendor")
currentDate <- Sys.Date()
csvFileName <- paste(currentDate,"_TCG",".csv",sep="")
write.csv(TCG_Vendor, file=csvFileName, row.names = FALSE) 
View(TCG_Vendor)
setwd("/cloud/project/Old Trackers/Low Confidence Reps")
...
Yesterday <- read_csv("/cloud/project/Old Trackers/High Confidence Reps/2020-01-06_Premium.csv")
Week_Ago <- read_csv("/cloud/project/Old Trackers/High Confidence Reps/2020-01-01_Premium.csv", 
