...
system('rm -rf /home/cujo253/mines_of_moria/cronR/data/lorcana-tcg')
system('rm /home/cujo253/mines_of_moria/cronR/data/lorcana_pull.log')

system('docker run --rm --platform linux/amd64 --user 1000:1000 -v /home/cujo253/mines_of_moria/cronR/data:/scraped-data/ mtgelmo/tcg_scraper:latest --category lorcana-tcg')
...
file_path = '/home/cujo253/mines_of_moria/cronR/data/lorcana-tcg/listings.csv'
listings_data_tibble =read_csv(file_path) %>% as_tibble()

file_path = '/home/cujo253/mines_of_moria/cronR/data/lorcana-tcg/product_data.csv'
product_data_tibble =read_csv(file_path) %>% as_tibble()

file_path = '/home/cujo253/mines_of_moria/cronR/data/lorcana-tcg/sellers.csv'
...
bq_import(upload_tibble = listings_data_tibble,
          dataset_name = 'docker_listings_lorcana_tcg',
          table_name='listings',
          event_date=Sys.Date())

bq_import(upload_tibble = product_data_tibble,
          dataset_name = 'docker_product_data_lorcana_tcg',
          table_name = 'product_data',
          event_date=Sys.Date())

bq_import(upload_tibble = sellers_data_tibble,
          dataset_name = 'docker_sellers_lorcana_tcg',
          table_name = 'sellers',
          event_date=Sys.Date())