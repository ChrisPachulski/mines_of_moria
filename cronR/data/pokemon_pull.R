...
system('rm -rf /home/cujo253/mines_of_moria/cronR/data/pokemon')
system('rm /home/cujo253/mines_of_moria/cronR/data/pokemon_pull.log')

system('docker run --rm --platform linux/amd64 --user 1000:1000 -v /home/cujo253/mines_of_moria/cronR/data:/scraped-data/ mtgelmo/tcg_scraper:latest --category pokemon')
...
file_path = '/home/cujo253/mines_of_moria/cronR/data/pokemon/listings.csv'
listings_data_tibble =read_csv(file_path) %>% as_tibble()

file_path = '/home/cujo253/mines_of_moria/cronR/data/pokemon/product_data.csv'
product_data_tibble =read_csv(file_path) %>% as_tibble()

file_path = '/home/cujo253/mines_of_moria/cronR/data/pokemon/sellers.csv'
...
bq_import(upload_tibble = listings_data_tibble,
          dataset_name = 'docker_listings_pokemon',
          table_name='listings',
          event_date=Sys.Date())

bq_import(upload_tibble = product_data_tibble,
          dataset_name = 'docker_product_data_pokemon',
          table_name = 'product_data',
          event_date=Sys.Date())

bq_import(upload_tibble = sellers_data_tibble,
          dataset_name = 'docker_sellers_pokemon',
          table_name = 'sellers',
          event_date=Sys.Date())